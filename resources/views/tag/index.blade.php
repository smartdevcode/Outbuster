        ...
        <section class="categories">
            <div class="title-wrap">
                ...
                <select class="form-select " name="tag" id="tag">
                    <option {{ $tag_id == '0' ? 'selected' : '' }} value="0">ALL</option>
                    @foreach ($tags as $item)
                        <option {{ $tag_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">
                            {!! $item->tag !!}</option>
                    @endforeach
                </select>
            </div>
            <div class="list">
                <div class="row">
                    @foreach ($films as $item)
                        <div class="col">
                            <div class="image"><img src="{{ asset('storage/' . $item->film_cover) }}" alt=""></div>
