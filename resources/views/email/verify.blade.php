                                                                ...
                                                                <td align="center" >
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td width="20"></td>
                                                                            <td>
                                                                                <a href="{{ route('verify',$details['token'])}}" class="btn" style="background:#120717; border-radius: 28px; font-size: 18px; line-height: 20px; font-family:'Arial'; color: #fff; width: 100%;min-width:150px; display: block; text-align: center; padding: 19px 10px; text-decoration: none;">S'inscrire
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
